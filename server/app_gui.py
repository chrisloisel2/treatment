...
class DiscoveryWorker(QThread):
    """Découvre les sessions dans /home/ia/workbench/."""
...
class IngestionPanel(QWidget):
    ...
    def _build_ui(self):
        ...
        # ── Liste des sessions ──
        grp_sess = QGroupBox("Sessions dans /home/ia/workbench/")
    ...
    def _on_result(self, sessions: list):
        ...
        self.log.log(f"[Ingestion] {len(sessions)} sessions dans /home/ia/workbench/", "OK")
...
class PipelinePanel(QWidget):
    ...
    def _build_ui(self):
        ...
        self.chk_delete_after = QCheckBox("Supprimer de /home/ia/workbench/ après store")
        self.chk_delete_after.setToolTip(
            "ATTENTION : supprime définitivement la session de /home/ia/workbench/ après copie vers silver.\n"
    ...
    def _run(self):
        ...
        if delete_after_store:
            ...
            ans = QMessageBox.warning(
                ...
                f"La session sera supprimée de /home/ia/workbench/ après copie vers/home/ia/silver.\n\n"
...
def main():
    ...
    win.log.log("1. Déposez vos sessions dans /home/ia/workbench/, puis scannez dans « Ingestion ».", "DIM")
