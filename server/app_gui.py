...
class DiscoveryWorker(QThread):
    """Découvre les sessions dans /mnt/storage/silver//."""
...
class IngestionPanel(QWidget):
    sessions_changed = pyqtSignal(list)  # session list (paths in /mnt/storage/silver/)
    ...
    def _build_ui(self):
        ...
        # ── Liste des sessions ──
        grp_sess = QGroupBox("Sessions dans /mnt/storage/silver//")
    ...
    def _on_result(self, sessions: list):
        ...
        self.log.log(f"[Ingestion] {len(sessions)} sessions dans /mnt/storage/silver//", "OK")
...
class PipelinePanel(QWidget):
    ...
    def _build_ui(self):
        ...
        vl = QVBoxLayout(grp_sess)
        self.combo_session = QComboBox()
        self.combo_session.setPlaceholderText("Choisir une session dans /mnt/storage/silver/…")
        vl.addWidget(self.combo_session)
        layout.addWidget(grp_sess)
        ...
        self.chk_delete_after = QCheckBox("Supprimer de /mnt/storage/silver// après store")
        self.chk_delete_after.setToolTip(
            "ATTENTION : supprime définitivement la session de /mnt/storage/silver// après copie vers silver.\n"
    ...
    def _run(self):
        ...
        if delete_after_store:
            ...
            ans = QMessageBox.warning(
                ...
                f"La session sera supprimée de /mnt/storage/silver// après copie vers/home/ia/silver.\n\n"
...
def main():
    ...
    win.log.log("1. Déposez vos sessions dans /mnt/storage/silver//, puis scannez dans « Ingestion ».", "DIM")
