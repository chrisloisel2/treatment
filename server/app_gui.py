...
class DiscoveryWorker(QThread):
    """Découvre les sessions dans /Users/christopher/Downloads/sync_test_1/treatment/data/."""
...
class IngestionPanel(QWidget):
    sessions_changed = pyqtSignal(list)  # session list (paths in /Users/christopher/Downloads/sync_test_1/treatment/data)
    ...
    def _build_ui(self):
        ...
        # ── Liste des sessions ──
        grp_sess = QGroupBox("Sessions dans /Users/christopher/Downloads/sync_test_1/treatment/data/")
    ...
    def _on_result(self, sessions: list):
        ...
        self.log.log(f"[Ingestion] {len(sessions)} sessions dans /Users/christopher/Downloads/sync_test_1/treatment/data/", "OK")
...
class PipelinePanel(QWidget):
    ...
    def _build_ui(self):
        ...
        vl = QVBoxLayout(grp_sess)
        self.combo_session = QComboBox()
        self.combo_session.setPlaceholderText("Choisir une session dans /Users/christopher/Downloads/sync_test_1/treatment/data…")
        vl.addWidget(self.combo_session)
        layout.addWidget(grp_sess)
        ...
        self.chk_delete_after = QCheckBox("Supprimer de /Users/christopher/Downloads/sync_test_1/treatment/data/ après store")
        self.chk_delete_after.setToolTip(
            "ATTENTION : supprime définitivement la session de /Users/christopher/Downloads/sync_test_1/treatment/data/ après copie vers silver.\n"
    ...
    def _run(self):
        ...
        if delete_after_store:
            ...
            ans = QMessageBox.warning(
                ...
                f"La session sera supprimée de /Users/christopher/Downloads/sync_test_1/treatment/data/ après copie vers/home/ia/silver.\n\n"
...
def main():
    ...
    win.log.log("1. Déposez vos sessions dans /Users/christopher/Downloads/sync_test_1/treatment/data/, puis scannez dans « Ingestion ».", "DIM")
